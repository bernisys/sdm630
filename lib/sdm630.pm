...
my %RRD_PARAMS = (
  'charge'              => { 'type' => 'GAUGE', 'unit' => 'Ah',    'rows' => ['Ah:0:U', ], },
  'current'             => { 'type' => 'GAUGE', 'unit' => 'A',     'rows' => ['L1:0:100', 'L2:0:100', 'L3:0:100', 'N:0:100', 'avg:0:100', 'sum:0:100', ], },
  'current_demand'      => { 'type' => 'GAUGE', 'unit' => 'A',     'rows' => ['L1:0:100', 'L2:0:100', 'L3:0:100', ], },
  'current_demandmax'   => { 'type' => 'GAUGE', 'unit' => 'A',     'rows' => ['L1:0:100', 'L2:0:100', 'L3:0:100', ], },
  'energy_kvah_total'   => { 'type' => 'GAUGE', 'unit' => 'kVAh',  'rows' => ['tot:0:U', ], },
  'energy_kvarh_export' => { 'type' => 'GAUGE', 'unit' => 'kVarh', 'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kvarh_import' => { 'type' => 'GAUGE', 'unit' => 'kVarh', 'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kvarh_total'  => { 'type' => 'GAUGE', 'unit' => 'kVarh', 'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kwh_export'   => { 'type' => 'GAUGE', 'unit' => 'kWh',   'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kwh_import'   => { 'type' => 'GAUGE', 'unit' => 'kWh',   'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kwh_total'    => { 'type' => 'GAUGE', 'unit' => 'kWh',   'rows' => ['L1:0:U', 'L2:0:U', 'L3:0:U', 'tot:0:U', ], },
  'energy_kwh_periodic' => { 'type' => 'GAUGE', 'unit' => 'kWh',   'rows' => ['imp:0:U', 'exp:0:U', 'tot:0:U',], },
  'frequency'           => { 'type' => 'GAUGE', 'unit' => 'Hz',    'rows' => ['Hz:30:70', ], },
  'phi'                 => { 'type' => 'GAUGE', 'unit' => '°',     'rows' => ['L1:-360:360', 'L2:-360:360', 'L3:-360:360', 'sum:-360:360', ], },
  'power_va'            => { 'type' => 'GAUGE', 'unit' => 'VA',    'rows' => ['L1:-20000:20000', 'L2:-20000:20000', 'L3:-20000:20000', 'sum:-60000:60000', ], },
  'power_var'           => { 'type' => 'GAUGE', 'unit' => 'Var',   'rows' => ['L1:-20000:20000', 'L2:-20000:20000', 'L3:-20000:20000', 'sum:-60000:60000', ], },
  'power_w'             => { 'type' => 'GAUGE', 'unit' => 'W',     'rows' => ['L1:-20000:20000', 'L2:-20000:20000', 'L3:-20000:20000', 'sum:-60000:60000', 'imp:-60000:60000', 'exp:-60000:60000', ], },
  'power_va_demand'     => { 'type' => 'GAUGE', 'unit' => 'VA',    'rows' => ['max:0:60000', 'tot:0:60000', ], },
  'power_w_demand'      => { 'type' => 'GAUGE', 'unit' => 'W',     'rows' => ['max:0:60000', 'tot:0:60000', ], },
  'powerfactor'         => { 'type' => 'GAUGE', 'unit' => '',      'rows' => ['L1:-1:1', 'L2:-1:1', 'L3:-1:1', 'sum:-1:1', ], },
  'thd_voltage_l'       => { 'type' => 'GAUGE', 'unit' => '%',     'rows' => ['L1:0:110', 'L2:0:110', 'L3:0:110', 'avg:0:110', ], },
  'thd_current'         => { 'type' => 'GAUGE', 'unit' => '%',     'rows' => ['L1:0:110', 'L2:0:110', 'L3:0:110', 'avg:0:110', ], },
  'voltage_l'           => { 'type' => 'GAUGE', 'unit' => 'V',     'rows' => ['L1:0:270', 'L2:0:270', 'L3:0:270', 'avg:0:270', ], },
  'voltage_ll'          => { 'type' => 'GAUGE', 'unit' => 'V',     'rows' => ['L1L2:0:420', 'L2L3:0:420', 'L3L1:0:420', 'avg:0:420', ], },
);
