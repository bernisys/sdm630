...
my %GRAPHS = (
  ...
  'registers' => {
    'holding' => {
      ...
      'input' => {
        '30001' => { 'group' => 'voltage_ln',           'datapoint' => 'L1',   'description' => 'phase 1 line to neutral voltage',                     },
        '30003' => { 'group' => 'voltage_ln',           'datapoint' => 'L2',   'description' => 'phase 2 line to neutral voltage',                     },
        '30005' => { 'group' => 'voltage_ln',           'datapoint' => 'L3',   'description' => 'phase 3 line to neutral voltage',                     },
        '30007' => { 'group' => 'current',              'datapoint' => 'L1',   'description' => 'phase 1 current',                                     },
        '30009' => { 'group' => 'current',              'datapoint' => 'L2',   'description' => 'phase 2 current',                                     },
        '30011' => { 'group' => 'current',              'datapoint' => 'L3',   'description' => 'phase 3 current',                                     },
        '30013' => { 'group' => 'power_w',              'datapoint' => 'L1',   'description' => 'phase 1 active power',                                },
        '30015' => { 'group' => 'power_w',              'datapoint' => 'L2',   'description' => 'phase 2 active power',                                },
        '30017' => { 'group' => 'power_w',              'datapoint' => 'L3',   'description' => 'phase 3 active power',                                },
        '30019' => { 'group' => 'power_va',             'datapoint' => 'L1',   'description' => 'phase 1 apparent power',                              },
        '30021' => { 'group' => 'power_va',             'datapoint' => 'L2',   'description' => 'phase 2 apparent power',                              },
        '30023' => { 'group' => 'power_va',             'datapoint' => 'L3',   'description' => 'phase 3 apparent power',                              },
        '30025' => { 'group' => 'power_var',            'datapoint' => 'L1',   'description' => 'phase 1 reactive power',                              },
        '30027' => { 'group' => 'power_var',            'datapoint' => 'L2',   'description' => 'phase 2 reactive power',                              },
        '30029' => { 'group' => 'power_var',            'datapoint' => 'L3',   'description' => 'phase 3 reactive power',                              },
        '30031' => { 'group' => 'powerfactor',          'datapoint' => 'L1',   'description' => 'phase 1 power factor',                                },
        '30033' => { 'group' => 'powerfactor',          'datapoint' => 'L2',   'description' => 'phase 2 power factor',                                },
        '30035' => { 'group' => 'powerfactor',          'datapoint' => 'L3',   'description' => 'phase 3 power factor',                                },
        '30037' => { 'group' => 'phi',                  'datapoint' => 'L1',   'description' => 'phase 1 angle',                                       },
        '30039' => { 'group' => 'phi',                  'datapoint' => 'L2',   'description' => 'phase 2 angle',                                       },
        '30041' => { 'group' => 'phi',                  'datapoint' => 'L3',   'description' => 'phase 3 angle',                                       },
        '30043' => { 'group' => 'voltage_ln',           'datapoint' => 'avg',  'description' => 'average line to neutral voltage',                     },
        '30047' => { 'group' => 'current_ln',           'datapoint' => 'avg',  'description' => 'average line current',                                },
        '30049' => { 'group' => 'current_ln',           'datapoint' => 'sum',  'description' => 'sum of all line currents',                            },
        '30053' => { 'group' => 'power_w',              'datapoint' => 'sum',  'description' => 'total system active power',                           },
        '30057' => { 'group' => 'power_va',             'datapoint' => 'sum',  'description' => 'total system apparent power',                         },
        '30061' => { 'group' => 'power_var',            'datapoint' => 'sum',  'description' => 'total system reactive power',                         },
        '30063' => { 'group' => 'powerfactor',          'datapoint' => 'sum',  'description' => 'total system power factor',                           },
        '30067' => { 'group' => 'phi',                  'datapoint' => 'sum',  'description' => 'total system phase angle',                            },
        '30071' => { 'group' => 'frequency',            'datapoint' => 'Hz',   'description' => 'grid frequency',                                      },
        '30073' => { 'group' => 'energy_kwh_import',    'datapoint' => 'tot',  'description' => 'total active energy import',                          },
        '30075' => { 'group' => 'energy_kwh_export',    'datapoint' => 'tot',  'description' => 'total active energy export',                          },
        '30077' => { 'group' => 'energy_kvarh_import',  'datapoint' => 'tot',  'description' => 'total reactive energy import',                        },
        '30079' => { 'group' => 'energy_kvarh_export',  'datapoint' => 'tot',  'description' => 'total reactive energy export',                        },
        '30081' => { 'group' => 'energy_kvah_total',    'datapoint' => 'tot',  'description' => 'total apparent energy',                               },
        '30083' => { 'group' => 'charge',               'datapoint' => 'Ah',   'description' => 'Charge',                                              },
        '30085' => { 'group' => 'power_w_demand',       'datapoint' => 'tot',  'description' => 'total system active power demand',                    },
        '30087' => { 'group' => 'power_w_demand',       'datapoint' => 'max',  'description' => 'maximum total system active power demand',            },
        '30101' => { 'group' => 'power_va_demand',      'datapoint' => 'tot',  'description' => 'total system apparent power demand',                  },
        '30103' => { 'group' => 'power_va_demand',      'datapoint' => 'max',  'description' => 'maximum total system apparent power demand',          },
        '30105' => { 'group' => 'current_demand',       'datapoint' => 'N',    'description' => 'neutral current demand',                              },
        '30107' => { 'group' => 'current_demand',       'datapoint' => 'Nmax', 'description' => 'maximum neutral current demand',                      },
        '30201' => { 'group' => 'voltage_ll',           'datapoint' => 'L1L2', 'description' => 'line 1 to line 2 voltage',                            },
        '30203' => { 'group' => 'voltage_ll',           'datapoint' => 'L2L3', 'description' => 'line 2 to line 3 voltage',                            },
        '30205' => { 'group' => 'voltage_ll',           'datapoint' => 'L3L1', 'description' => 'line 3 to line 1 voltage',                            },
        '30207' => { 'group' => 'voltage_ll',           'datapoint' => 'avg',  'description' => 'average line to line voltage',                        },
        '30225' => { 'group' => 'current',              'datapoint' => 'N',    'description' => 'neutral current',                                     },
        '30235' => { 'group' => 'thd_voltage_ln',       'datapoint' => 'L1',   'description' => 'phase 1 line to neutral total harmonic distortion',   },
        '30237' => { 'group' => 'thd_voltage_ln',       'datapoint' => 'L2',   'description' => 'phase 2 line to neutral total harmonic distortion',   },
        '30239' => { 'group' => 'thd_voltage_ln',       'datapoint' => 'L3',   'description' => 'phase 3 line to neutral total harmonic distortion',   },
        '30241' => { 'group' => 'thd_current',          'datapoint' => 'L1',   'description' => 'phase 1 line current total harmonic distortion',      },
        '30243' => { 'group' => 'thd_current',          'datapoint' => 'L2',   'description' => 'phase 2 line current total harmonic distortion',      },
        '30245' => { 'group' => 'thd_current',          'datapoint' => 'L3',   'description' => 'phase 3 line current total harmonic distortion',      },
        '30249' => { 'group' => 'thd_voltage_ln',       'datapoint' => 'avg',  'description' => 'average line to neutral total harmonic distortion',   },
        '30251' => { 'group' => 'thd_current',          'datapoint' => 'avg',  'description' => 'average line current total harmonic distortion',      },
      },
    },
  },
  'diagrams' => {
